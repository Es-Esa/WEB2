...
//lisäilin cors jotta saan käytettyä fetchiä frontendissä
const cors = require('cors');


const app = express();
app.use(cors());//tämä lisätty myös
...
//täytyy huomioida että reactiappi käyttä samaa porttia kun express.. meinas mennä hetki tajuta miksi bäkkäri ei toimi :D
app.listen(3000, () => {
